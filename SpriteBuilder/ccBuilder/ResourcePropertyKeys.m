...
NSString *const RESOURCE_PROPERTY_DEPRECATED_KEEP_SPRITES_UNTRIMMED = @"keepSpritesUntrimmed";

NSString *const RESOURCE_PROPERTY_DEPRECATED_TABLETSCALE = @"tabletScale";
